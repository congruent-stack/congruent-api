...
import { RequestFailureErrorThrownOutput } from "./api_client_http_method_call.js";
...
export type ClientHttpMethodEndpointHandler = 
  (input: ClientHttpMethodEndpointHandlerInput) => Promise<
    | ClientHttpMethodEndpointHandlerOutput 
